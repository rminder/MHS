CREATE TABLE [SF].[ServiceMaxSiteHistory] (
    [RowId]                            INT              NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_ServiceMaxSiteHistory_RowId]
    ON [SF].[ServiceMaxSiteHistory]([RowId] ASC);


GO
CREATE CLUSTERED INDEX [ix_ServiceMaxSiteHistory]
    ON [SF].[ServiceMaxSiteHistory]([ValidTo] ASC, [ValidFrom] ASC);
