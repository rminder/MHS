CREATE TABLE [SF].[ServiceMaxRmaShipmentOrder] (
    ...
    CONSTRAINT [PKServiceMaxRmaShipmentOrder] PRIMARY KEY CLUSTERED ([RowId] ASC),
    PERIOD FOR SYSTEM_TIME ([ValidFrom], [ValidTo])
)
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[SF].[ServiceMaxRmaShipmentOrderHistory], DATA_CONSISTENCY_CHECK=ON));


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_ServiceMaxRmaShipmentOrder_Id]
    ON [SF].[ServiceMaxRmaShipmentOrder]([Id] ASC);
