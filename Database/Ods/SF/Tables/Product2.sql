CREATE TABLE [SF].[Product2] (
    ...
    CONSTRAINT [PKProduct2] PRIMARY KEY CLUSTERED ([RowId] ASC),
    PERIOD FOR SYSTEM_TIME ([ValidFrom], [ValidTo])
)
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[SF].[Product2History], DATA_CONSISTENCY_CHECK=ON));


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Product2_Id]
    ON [SF].[Product2]([Id] ASC);
