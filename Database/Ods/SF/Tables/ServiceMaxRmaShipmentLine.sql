CREATE TABLE [SF].[ServiceMaxRmaShipmentLine] (
    ...
    CONSTRAINT [PKServiceMaxRmaShipmentLine] PRIMARY KEY CLUSTERED ([RowId] ASC),
    PERIOD FOR SYSTEM_TIME ([ValidFrom], [ValidTo])
)
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[SF].[ServiceMaxRmaShipmentLineHistory], DATA_CONSISTENCY_CHECK=ON));


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_ServiceMaxRmaShipmentLine_Id]
    ON [SF].[ServiceMaxRmaShipmentLine]([Id] ASC);
