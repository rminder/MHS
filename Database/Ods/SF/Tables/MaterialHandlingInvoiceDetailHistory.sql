CREATE TABLE [SF].[MaterialHandlingInvoiceDetailHistory] (
    [RowId]                               INT              NOT NULL,
...
GO
CREATE CLUSTERED INDEX [ix_MaterialHandlingInvoiceDetailHistory]
    ON [SF].[MaterialHandlingInvoiceDetailHistory]([ValidTo] ASC, [ValidFrom] ASC);
