CREATE TABLE [SF].[ServiceMaxServiceOrderLineHistory] (
    [RowId]                      INT              NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_ServiceMaxServiceOrderLineHistory_RowId]
    ON [SF].[ServiceMaxServiceOrderLineHistory]([RowId] ASC);


GO
CREATE CLUSTERED INDEX [ix_ServiceMaxServiceOrderLineHistory]
    ON [SF].[ServiceMaxServiceOrderLineHistory]([ValidTo] ASC, [ValidFrom] ASC);
