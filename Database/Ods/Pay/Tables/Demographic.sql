CREATE TABLE [Pay].[Demographic] (
    ...
    CONSTRAINT [PKDemographic] PRIMARY KEY CLUSTERED ([RowId] ASC),
    PERIOD FOR SYSTEM_TIME ([ValidFrom], [ValidTo])
)
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[Pay].[DemographicHistory], DATA_CONSISTENCY_CHECK=ON));


GO
CREATE NONCLUSTERED INDEX [IX_Demographic_ImportFileName]
    ON [Pay].[Demographic]([ImportFileName] ASC);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Demographic_CompanyId_EmployeeId]
    ON [Pay].[Demographic]([CompanyId] ASC, [EmployeeId] ASC);
