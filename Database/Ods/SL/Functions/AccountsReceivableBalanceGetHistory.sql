...
--		table.
-- =============================================
CREATE FUNCTION [SL].[AccountsReceivableBalanceGetHistory]
(
...
BEGIN
	...
	FROM SL.AccountsReceivableBalance FOR SYSTEM_TIME ALL
	WHERE
	...
	FROM SL.AccountsReceivableBalance FOR SYSTEM_TIME ALL T 
	...
	SELECT DISTINCT
		...
		,T.[LastInvoiceDate]
		,T.[LastStatementBalance00]
		,T.[LastStatementBalance01]
		,T.[LastStatementBalance02]
		,T.[LastStatementBalance03]
		,T.[LastStatementBalance04]
		,T.[LastStatementBeginBalance]
		,T.[LastStatementDate]
