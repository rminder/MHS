...
--		table.
-- =============================================
CREATE FUNCTION [SL].[AccountsPayableTransactionGetHistory]
(
...
(
	...
	[SubSeg1] [VARCHAR](6) NOT NULL,
	[SubSeg2] [VARCHAR](6) NOT NULL,
...
BEGIN
	...
	FROM SL.AccountsPayableTransaction FOR SYSTEM_TIME ALL
	WHERE
	...
	FROM SL.AccountsPayableTransaction FOR SYSTEM_TIME ALL T 
