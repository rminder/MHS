...
--		table.
-- =============================================
CREATE FUNCTION [SL].[AccountsReceivableDocumentGetHistory]
(
...
BEGIN
	...
	FROM SL.AccountsReceivableDocument FOR SYSTEM_TIME ALL
	WHERE
	...
	FROM SL.AccountsReceivableDocument FOR SYSTEM_TIME ALL T 
