CREATE TABLE [SL].[AccountsPayableHistoryHistory] (
    [RowId]                       INT              NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_AccountsPayableHistoryHistory_RowId]
    ON [SL].[AccountsPayableHistoryHistory]([RowId] ASC);


GO
CREATE CLUSTERED INDEX [ix_AccountsPayableHistoryHistory]
    ON [SL].[AccountsPayableHistoryHistory]([ValidTo] ASC, [ValidFrom] ASC);
